    ...
    'pages' => [
        'settings' => [
            ...
            'schedule' => [
                ...
                'running_content' => 'Active schedule: :type backups every :value :unit. Cron rule: :cron. Note: cron follows calendar dates, so the next due time can be sooner than the configured interval depending on the current date.',
            ],
