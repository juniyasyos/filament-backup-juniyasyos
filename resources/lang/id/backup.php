    ...
    'pages' => [
        'settings' => [
            ...
            'schedule' => [
                ...
                'running_content' => 'Jadwal aktif: backup :type setiap :value :unit. Aturan cron: :cron. Catatan: cron mengikuti tanggal kalender, jadi Next Due bisa lebih cepat dari interval yang disetel tergantung tanggal saat ini.',
            ],
